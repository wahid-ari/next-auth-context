      ...
      <Layout>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 min-h-screen">
          ...
          <section className="text-gray-600 body-font py-8">
            <h1 className="text-center font-medium text-3xl dark:text-white mb-8">Get Data From API That Required Token</h1>
            ...
            <h1 className="text-center font-medium text-lg dark:text-white my-8">IN PAGE config token. using Token in AuthContext that saved in cookies.</h1>
            {data &&
              <>
            ...
            <h1 className="text-center font-medium text-lg dark:text-white mb-8">GLOBAL config token. using token from Cookies. Seems Ok</h1>
            {otherData &&
              <>
